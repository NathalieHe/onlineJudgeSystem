...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/@angular/core.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__assets_color__ = __webpack_require__("../../../../../src/assets/color.ts");
...
var DataService = (function () {
    ...
    DataService.prototype.buildAndRun = function (data) {
        ...
        return this.http.post('/api/v1/build_and_run', data, headers)
            .toPromise()
            .then(function (res) {
            console.log('in the client side build and run', res);
            return res.json();
        })
            .catch(this.handleError);
    };
